...
"""
Installation script for Benchmark's development virtualenv
"""
...
def print_help():
    help = """
 Benchmark development environment setup is complete.

 Benchmark development uses virtualenv to track and manage Python
 dependencies while in development and testing.

 To activate the benchmark virtualenv for the extent of your current
