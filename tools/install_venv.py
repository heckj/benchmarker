...
"""
Installation script for the OpenStack Benchmarks development virtualenv.
"""
...
def install_dependencies(venv=VENV):
    ...
    # Tell the virtual env how to "import benchmarks"
    py = 'python%d.%d' % (sys.version_info[0], sys.version_info[1])
    pthfile = os.path.join(venv, "lib", py, "site-packages", "benchmark.pth")
    f = open(pthfile, 'w')
    f.write("%s\n" % ROOT)
...
def print_summary():
    summary = """
 OpenStack Benchmarks development environment setup is complete.
